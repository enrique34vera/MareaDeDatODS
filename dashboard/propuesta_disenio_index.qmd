...
```{python}
#| component: valuebox
#| title: Alertamiento por tsunami
dict(
    icon="tsunami", 
    color="primary", 
    value=""
...
```{python}
#| component: valuebox
#| title: Alertamiento por huracán
dict(
    icon="hurricane", 
    color="primary", 
    value=""
