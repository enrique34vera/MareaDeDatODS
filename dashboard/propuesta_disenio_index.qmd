...
```
Fuente de los datos: [Atlas Nacional de Riesgos](http://www.atlasnacionalderiesgos.gob.mx/archivo/descargas.html)
:::
...
```
Fuente de los datos: [Instituto Nacional de Estadística y Geografía (INEGI)](https://www.inegi.org.mx/programas/ccpv/2020/#datos\_abiertos)
:::
...
dict(
    icon="cloud-rain", 
    color="primary", 
    value=round(pronostico_meteorologia['hourly_precip_mm'][62], 2)
)
```
### Column
```{python}
...
[¡Conoce los riesgos por altas temperaturas!](https://www.imss.gob.mx/sites/all/statics/pdf/guarderias/onda-calor.pdf)
```{python}
#| output: False
fig=go.Figure()
...
```
Fuente de los datos: [Servicio Mareográfico Nacional](https://www.mareografico.unam.mx/estaciones/?estacion=1) (datos medidos), [Instituto de Ciencias de la Atmósfera y Cambio Climático](https://pronosticos.atmosfera.unam.mx/) (datos pronóstico)
:::

### Column
::: {.card title="Conoce más"}
[¿Qué tan fuerte va a llover?](https://x.com/conagua_clima/status/1017166937569161217)
```{python}
#| output: False
fig=go.Figure()
...
```
Fuente de los datos: [Instituto de Ciencias de la Atmósfera y Cambio Climático](https://pronosticos.atmosfera.unam.mx/)

:::

### Column
::: {.card title="Conoce más"}
[¿Qué hago si hay vientos fuertes?](https://www.facebook.com/photo/?fbid=1299650188878277&set=a.466284112214893)
```{python}
#| output: False
fig=go.Figure()
...
```
Fuente de los datos: [Servicio Mareográfico Nacional](https://www.mareografico.unam.mx/estaciones/?estacion=1)
:::

### Column
::: {.card title="Conoce más"}
[¡Cuidado con el oleaje alto!](https://www.facebook.com/photo/?fbid=1156721736491620&set=pcb.1156721779824949)
```{python}
fig=go.Figure()
...
### Column
::: {.card title="Conoce más"}
[¿Qué hago si hay marejadas?](https://www.facebook.com/photo/?fbid=1380740490766282&set=a.360223536151321)
```{python}
figH=go.Figure()
...
[Consulta el último boletín del Centro de Alerta de Tsunamis](https://diredimoat.semar.gob.mx/cat/centroAlertasTsunamis.html)
```{python}
#| echo: false
print(sem_tsunami)
```
...
[Consulta el pronóstico del Servicio Meteorológico](https://smn.conagua.gob.mx/es/pronosticos/pronosticossubmenu/pronostico-meteorologico-general)
```{python}
#| echo: false
print(sem_huracan)
```
