---
title: VERACRUZ:InforMARte es cuidarte
...
```
```{python}
#| title: Conoce los fenómenos meteorológicos y del mar que afectaron a Veracruz durante 2000 - 2024
...
```
```{python}
#| title: Conoce el impacto de fenómenos meteorológicos y del mar durante 2000 - 2024
#| layout-ncol: 2
...
```{python}
#| echo: false
# semáforo de humedad (sin umbral definido aún)
print("Alerta por humedad: 🟢")
```
...
figT.update_layout(xaxis_title=" ", yaxis_title="[°C]", margin=dict(l=40,r=10,t=18,b=25), legend=dict(orientation="h", y=1.15, x=0))
```
### Column
```{python}
#| output: False
...
figM.update_layout(xaxis_title=" ", yaxis_title="[m]", margin=dict(l=40,r=10,t=18,b=25), legend=dict(orientation="h", y=1.15, x=0))
```
### Column
### Column
...
figV.update_layout(xaxis_title=" ", yaxis_title="[m/s]", margin=dict(l=40,r=10,t=18,b=25))
```
...
figH.update_layout(xaxis_title=" ", yaxis_title="[%]", margin=dict(l=40,r=10,t=18,b=25))
```
